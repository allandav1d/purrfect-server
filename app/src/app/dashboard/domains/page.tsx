...
const domainProviders = [
  {
    id: "cloudflare",
    name: "Cloudflare",
    tutorialUrl: "https://cloudflare.com/pt-br/dns",
  },
  {
    id: "godaddy",
    name: "GoDaddy",
    tutorialUrl:
      "https://br.godaddy.com/help/adicionar-um-registro-tipo-a-19238",
  },
  {
    id: "hostgator",
    name: "HostGator",
    tutorialUrl:
      "https://suporte.hostgator.com.br/hc/pt-br/articles/115004251133",
  },
  {
    id: "namecheap",
    name: "Namecheap",
  ...
  },
  {
    id: "registro.br",
    name: "Registro.br",
    tutorialUrl: "https://registro.br/tecnologia/ferramentas/dns",
  },
]
...
export default function DomainsPage() {
  ...
  const { data: serverSettingsIpv6 } = api.settings.get.useQuery({
    key: "server_ipv6",
  })
          ...
          <div className="flex items-center justify-between">
            ...
            <Dialog open={tutorialOpen} onOpenChange={setTutorialOpen}>
              ...
              <DialogContent className="">
                <DialogHeader className="sticky top-0 z-10 border-b bg-background pb-4 pt-6">
                  <DialogTitle className="text-xl">
                    Tutorial de Configuração
                  </DialogTitle>
                  <DialogDescription className="text-muted-foreground">
                    Aprenda como configurar seu domínio para apontar para este
                    servidor
                  </DialogDescription>
                </DialogHeader>
                <div className="space-y-4 p-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-medium">
                      Selecione seu provedor de domínio:
                    </label>
                    <Select
                      ...
                      <AccordionContent>
                        <div className="space-y-4">
                          <ol className="list-inside list-decimal space-y-2">
                            <li>
                              Acesse o painel de controle do seu provedor de
                              domínio
                            </li>
                            <li>Localize a seção de gerenciamento de DNS</li>
                            <li>
                              Adicione um registro do tipo A apontando para o
                              IPv4:{" "}
                            ...
                            {serverIpv6 && (
                              <li>
                                Adicione um registro do tipo AAAA apontando para
                                o IPv6:{" "}
                                <code className="rounded bg-muted px-1 py-0.5">
                                  {serverIpv6}
                                </code>
                            ...
                            <li>
                              Aguarde a propagação do DNS (pode levar até 24
                              horas)
                            </li>
                          </ol>
                          {selectedProvider && (
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                ...
                {domainToDelete?.domain}? Esta ação não pode ser desfeita.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
